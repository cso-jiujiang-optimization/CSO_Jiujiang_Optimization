...
**Fig 13 Breakpoint Analysis:** The script rigorously applies a 2nd-degree localized polynomial regression strictly within the active hydrologic reversal zone (7-30 mm). By calculating the mathematical vertex of the fitted parabola:

$$X_{\text{peak}} = -\frac{c_1}{2c_2}$$

it exacts the threshold at 18.0 mm with $R^2 = 0.989$, statistically validating the volumetric dilution effect.
